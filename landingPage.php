...
<body>
    <header>
        <div class="header-links">
            <a href="#" class="header-info"><h2 class="heading">RECRUITMENT REVOLUTION</h2></a>
            <!-- <a href="#" class="header-info">Sign In</a>
            <a href="#" class="header-info">Sign Up</a>
            <a href="#" class="header-info">Join Us</a> -->
        </div>
    </header>

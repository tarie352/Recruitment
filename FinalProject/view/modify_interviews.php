...
<body>
    ...
    <?php include('../actions/interviewInfo.php'); ?>
    <div class="container">
        <div class="container">
            <div class="registration-form">
                <form action="../actions/edit_interviews.php" method="post">
                    ...
                    <button type="button" onclick="window.location.href = '../view/main.php';" style="margin-top:30px;margin-left:30px;background-color:#007bff ;color:white">Main Page</button>
                    <button type="button" onclick="window.location.href = '../view/interviewsInfo.php';" style="background-color:#007bff ;color:white">Interview Information Page</button>
